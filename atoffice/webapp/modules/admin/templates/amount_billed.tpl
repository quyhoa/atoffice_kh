...
<td><span style='margin:5px;'>({$item.bill_id})</span></td>
<td bgcolor=#FFD9DC width=100><span style='margin:5px;'>仮想口座番号</span></td>
<td><span style='margin:5px;'>({$item.virtual_code})</span></td>
</td>
</tr>
...
<td><span style='margin:5px;'>({$item.total_billed_money}) 円</span></td>
<td bgcolor=#FFD9DC width=100><span style='margin:5px;'>現在入金額</span></td>
<td><span style='margin:5px;'>({$item.pay_money}) 円</span></td>
</td>
</tr>
