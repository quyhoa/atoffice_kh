...
define('OPENPNE_URL', 'http://atoffice.dev/');
//define('OPENPNE_URL', 'http://211.16.227.45/atoffice/');
...
'dsn'  => array(
   ...
   'password' => '',
   'hostspec' => '127.0.0.1',
   'database' => 'server_at_office_16032016',
   'new_link' => false,
	// 'phptype'  => 'mysql',
 //    'username' => 'root',
 //    'password' => '1234!@#$',
...
define('ENCRYPT_KEY', 'faeoiafwenl564165faeia893efsasjk15616afe2asdf');

// メールサーバードメイン
// 携帯メール投稿の宛先などのドメイン名に使われる
define('MAIL_SERVER_DOMAIN', '127.0.0.1');
