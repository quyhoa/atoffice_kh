...
<input type="hidden" name="page" value="do_set_reserve_s">
...
<br><br>
<div style="font-size: 22px; font-weight: bold;">サービス一覧</div>
<br>
<!--
<table width="604" height="116" bgcolor="#FAFAFA" style="border: 1px solid #CDCDCD; border-collapse: collapse; empty-cells: show;">
<tr>
<td>お弁当メモを記載</td>
</tr>
</table>
...
<th bgcolor=#CDCDCD style='border: 1px #000000 solid;text-align: center;'>名称</th>
<th bgcolor=#CDCDCD style='border: 1px #000000 solid;text-align: center;'>価格</th>
<th bgcolor=#CDCDCD style='border: 1px #000000 solid;text-align: center;'>数量</th>
<th bgcolor=#CDCDCD style='border: 1px #000000 solid;text-align: center;'>キャンセル料に<br>含まれるか</th>
...
foreach($service_list as $key=>$value){
	...
	print "<tr><td style='border: 1px #000000 solid;text-align: center;vertical-align:middle;'>";
	print "<input type='checkbox' name='select_service".$key."' value=".$value['service_id']." onclick=\"service_price_change(".count($service_list).")\">";
	print "</td><td style='border: 1px #000000 solid;text-align: center;vertical-align:middle;'>";
	print $value['service_name'];
	print "</td><td style='border: 1px #000000 solid;text-align: right;vertical-align:middle;' nowrap>";
...
/// 2013.12.21 消費税改定対応 begin
	...
	print "<span id='service_tanka".$key."' style='display:none;'>".$tmp_price."</span>";
...
/// 2013.12.21 消費税改定対応 end
	...
	print "<table>";
	print "<tr><td>";
	print "<input style='font:30px;height:30px;text-align:right;vertical-align:bottom;' type=text name=service_remainder".$key." value=".$value['minimum_orders']." size=4 onChange=\"check_val(".$key.", ".$value['minimum_orders'].", ".$service_num.")\"></td><td>";
	print "<input type=button value='+' onClick='plus(".$key.", ".count($service_list).")'><br><input type=button value='-' onClick=\"minus(".$key.", ".$value['minimum_orders'].", ".$service_num.")\"></td></tr>";
	print "</table><br>";
	print "(最低予約数：".$value['minimum_orders'].")";
...
<span id="reserve_service_price">0</span> 円(税込)
</td>
</tr>
</table>
<?php
	}else{
		print "<span id='reserve_service_price' style='display:none;'>0</span>";
	}
?>
<br>
<table width=600>
...
<INPUT TYPE="image" src="./atoffice/img/btn_regserv.png" VALUE="">
</td>
</tr>
</table>
