...
({if $room_data.$item.type==1})
({if $hall_begin1})
<td height=20 colspan=({$hall_begin1}) align=center bgcolor=#000000>
</td>
({/if})

({foreach from=$room_data.$item.span_list1 item=item2})
...
<td height=20 colspan=({$day_time-$hall_finish1}) align=center bgcolor=#000000></td>
...
({foreach from=$room_data.$item.loop_list1 item=item2})
    <td colspan=({$room_data.$item.koma}) bgcolor=#66CC00></td>
({/foreach})
({foreach from=$room_data.$item.etc_list1 item=item2})
    <td bgcolor=#FF6600></td>
({/foreach})
({if $day_time-$hall_finish1+1})
<td height=20 colspan=({$day_time-$hall_finish1+1}) align=center bgcolor=#000000></td>
({/if})
({/if})
...
<th width=20 colspan=({$room_data.$item.th_span})>24</th>
</tr>
<tr>

<td colspan=({$hall_begin1*$room_data.$item.th_span}) bgcolor=#000000></td>

({foreach from=$room_data.$item.minutes item=min})

({if $min>$hall_begin1 and $min<=$hall_finish1})
...
<td colspan=24-({$hall_finish1}) bgcolor=#000000></td>
...
({if $room_data.$item.type==1})
({if $hall_begin2})
<td height=20 colspan=({$hall_begin2}) align=center bgcolor=#000000>
</td>
({/if})

({foreach from=$room_data.$item.span_list2 item=item2})
...
<td height=20 colspan=({$day_time-$hall_finish2}) align=center bgcolor=#000000></td>
...
({foreach from=$room_data.$item.loop_list2 item=item2})
    <td colspan=({$room_data.$item.koma}) bgcolor=#66CC00></td>
({/foreach})
({foreach from=$room_data.$item.etc_list2 item=item2})
    <td bgcolor=#FF6600></td>
({/foreach})
({if $day_time-$hall_finish2+1})
<td height=20 colspan=({$day_time-$hall_finish2+1}) align=center bgcolor=#000000></td>
({/if})
({/if})
...
<td colspan=({$hall_begin2*$room_data.$item.th_span}) bgcolor=#000000></td>

({foreach from=$room_data.$item.minutes item=min})

({if $min>$hall_begin2 and $min<=$hall_finish2})
...
<td colspan=24-({$hall_finish2}) bgcolor=#000000></td>
...
({if $room_data.$item.type==1})
({if $hall_begin3})
<td height=20 colspan=({$hall_begin3}) align=center bgcolor=#000000>
</td>
({/if})

({foreach from=$room_data.$item.span_list3 item=item2})
...
<td height=20 colspan=({$day_time-$hall_finish3}) align=center bgcolor=#000000></td>
...
({foreach from=$room_data.$item.loop_list3 item=item2})
    <td colspan=({$room_data.$item.koma}) bgcolor=#66CC00></td>
({/foreach})
({foreach from=$room_data.$item.etc_list3 item=item2})
    <td bgcolor=#FF6600></td>
({/foreach})
({if $day_time-$hall_finish3+1})
<td height=20 colspan=({$day_time-$hall_finish3+1}) align=center bgcolor=#000000></td>
({/if})
({/if})
...
<td colspan=({$hall_begin3*$room_data.$item.th_span}) bgcolor=#000000></td>

({foreach from=$room_data.$item.minutes item=min})

({if $min>$hall_begin3 and $min<=$hall_finish3})
...
<td colspan=24-({$hall_finish3}) bgcolor=#000000></td>
...
({if $room_data.$item.type==1})
({if $hall_begin4})
<td height=20 colspan=({$hall_begin4}) align=center bgcolor=#000000>
</td>
({/if})

({foreach from=$room_data.$item.span_list4 item=item2})
...
<td height=20 colspan=({$day_time-$hall_finish4}) align=center bgcolor=#000000></td>
...
({foreach from=$room_data.$item.loop_list4 item=item2})
    <td colspan=({$room_data.$item.koma}) bgcolor=#66CC00></td>
({/foreach})
({foreach from=$room_data.$item.etc_list4 item=item2})
    <td bgcolor=#FF6600></td>
({/foreach})
({if $day_time-$hall_finish4+1})
<td height=20 colspan=({$day_time-$hall_finish4+1}) align=center bgcolor=#000000></td>
({/if})
({/if})
...
<td colspan=({$hall_begin4*$room_data.$item.th_span}) bgcolor=#000000></td>

({foreach from=$room_data.$item.minutes item=min})

({if $min>$hall_begin and $min<=$hall_finish4})
...
<td colspan=24-({$hall_finish4}) bgcolor=#000000></td>
