...
// メンバー強制退会 確認画面
class admin_page_customer_edit_detail extends OpenPNE_Action
{
	...
	$info = db_get_all($sql);
	$info[0]['info'] = isset($info[0]['info']) ? $info[0]['info'] : null;
	...
	$agency_data[0] = isset($agency_data[0]) ? $agency_data[0] : null;
