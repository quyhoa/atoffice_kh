...
class admin_page_add_hall extends OpenPNE_Action
{
	...
	if(isset($_POST['correction']) && $_POST['correction']==100){
		...
		foreach($col_list as $value){
			$post_data[$value['Field']] = isset($result[0][$value['Field']]) ? $result[0][$value['Field']] : null;
		}
		...
		$result1 = isset($result1[0]['usedate']) ? $result1[0]['usedate'] : null;
