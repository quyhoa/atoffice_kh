...
<td>
({if $post_data.c_member_id})
	<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('c_member_detail')})&amp;target_c_member_id=({$post_data.c_member_id})">({$post_data.c_member.nickname})【({$guest})】</a>
({else})
	新規契約者
({/if})
</td>
...
<td colspan=3>
<textarea id="mce_editor_textarea" name="message" rows="({$_rows|default:'4'})" cols="({$_cols|default:'70'})"></textarea>
</td>
</tr>
<tr>
