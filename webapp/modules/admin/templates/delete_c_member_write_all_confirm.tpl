...
<table class="userDetailTable">
	...
	<tr>
		<th>PCメールアドレス</th>
		<td>({if $c_member.secure.pc_address})<a href="mailto:({$c_member.secure.pc_address|escape:"hexentity"})">({$c_member.secure.pc_address|escape:"hexentity"})</a>({else})&nbsp;({/if})</td>
	</tr>
	<tr>
		<th>携帯メールアドレス</th>
		<td>({if $c_member.secure.ktai_address})<a href="mailto:({$c_member.secure.ktai_address})">({$c_member.secure.ktai_address})</a>({else})&nbsp;({/if})</td>
	</tr>
	<tr>
		<th>登録メールアドレス</th>
