...
({assign var="page_name" value="顧客情報管理"})
...
<input type="hidden" name="a" value="page_({$hash_tbl->hash('customer_edit')})" />
...
<p class="listMove">
({if $pager.prev_page})<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page=({$pager.prev_page})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})">前へ</a>({/if})
({foreach from=$pager.disp_pages item=i})
({if $i == $pager.page})&nbsp;|&nbsp;<strong>({$i})</strong>({else})&nbsp;|&nbsp;<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page=({$i})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})">({$i})</a>({/if})
({/foreach})
({if $pager.next_page})&nbsp;|&nbsp;<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page=({$pager.next_page})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})">次へ</a>
({/if})
</p>
...
<table class="userListTable">
	<thead>
		<tr>
			...
			<th class="cell03" rowspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=c_member_id-1({$cond})">▲</a>ID<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=c_member_id-2({$cond})">▼</a></th>
			({if $smarty.const.OPENPNE_AUTH_MODE != 'email'})
			<th class="cell19" rowspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=username-1({$cond})">▲</a>ログインID<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=username-2({$cond})">▼</a></th>
			({/if})
			<th class="cell04" rowspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=nickname-1({$cond})">▲</a>({$WORD_NICKNAME})<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=nickname-2({$cond})">▼</a></th>
			({if $smarty.const.OPENPNE_USE_POINT_RANK})
			<th class="cell10" colspan="2" rowspan="2"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=PNE_POINT-1-p({$cond})">▲</a>ポイント・ランク<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=PNE_POINT-2-p({$cond})">▼</a></th>
			({/if})
			<th class="cell05" rowspan="2"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=access_date-1({$cond})">▲</a>最終ログイン<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=access_date-2({$cond})">▼</a></th>
			<th class="cell06" rowspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=r_date-1({$cond})">▲</a>登録日<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=r_date-2({$cond})">▼</a></th>


			<th class="cell09" colspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=birth-1({$cond})">▲</a>生年月日<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=birth-2({$cond})">▼</a></th>
			({foreach from=$c_profile_list item=prof})
			({if $prof.name !== 'PNE_POINT'})
			<th rowspan="2"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$prof.name})-1({$cond})">▲</a>({$prof.caption})<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$prof.name})-2({$cond})">▼</a></th>
			({/if})
			({/foreach})
			<th class="cell16" rowspan="2">PCメールアドレス</th>

			<th class="cell18" rowspan="3">登録時メールアドレス</th>			<th class="cell17" rowspan="3">ゲスト</th>
			<th class="cell15" rowspan="3"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;order=c_member_id-1({$cond})">▲</a>ID<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;order=c_member_id-2({$cond})">▼</a></th>
		</tr>
		<tr>
		...
		<tr class="min_width">
            ...
            <select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;s_rank='+this.options[this.selectedIndex].value);">
			...
			～
			<select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;e_rank='+this.options[this.selectedIndex].value);">
			<option value="">▼選択</option>
			({foreach from=$rank_data item=item})
			...
			({/if})
			<th class="cell05">
            <select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;last_login='+this.options[this.selectedIndex].value);">
            <option value="">▼選択</option>
			...
			<select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;s_year='+this.options[this.selectedIndex].value);">
			<option value="">▼選択</option>
			...
			～
			<select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;e_year='+this.options[this.selectedIndex].value);">
			<option value="">▼選択</option>
			({foreach from=$years item=item})
			...
			<select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;profile[({$prof.name})]='+this.options[this.selectedIndex].value);">
			<option value="">▼選択</option>
			...
			({/foreach})
			<th class="cell05">
            <select class="basic" onChange="Link('?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit')})&amp;page_size=({$pager.page_size})&amp;order=({$requests.order})({$cond})&amp;is_pc_address='+this.options[this.selectedIndex].value);">
            <option value="">▼選択</option>
...
({******* 氏名 ******})
			<td class="cell03" width=150>({$item.c_member_id})</td>
			({if $smarty.const.OPENPNE_AUTH_MODE != 'email'})
			<td class="cell19">({$item.username})</td>
			({/if})
			<td class="cell04"><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('customer_edit_detail')})&amp;target_c_member_id=({$item.c_member_id})">({$item.nickname})</a></td>
			({if $smarty.const.OPENPNE_USE_POINT_RANK})
			...
			({/if})
			({/foreach})
			<td class="cell16">({if $item.secure.pc_address})<a href="mailto:({$item.secure.pc_address|escape:"hexentity"})">({$item.secure.pc_address|escape:"hexentity"})</a>({else})&nbsp;({/if})</td>

			<td class="cell18">({if $item.secure.regist_address})({$item.secure.regist_address})({else})&nbsp;({/if})</td>
			<td class="cell17">({$item.guest_flag})</td>
