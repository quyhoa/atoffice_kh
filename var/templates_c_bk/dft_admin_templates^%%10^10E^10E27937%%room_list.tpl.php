<?php /* Smarty version 2.6.18, created on 2010-09-01 08:28:03
         compiled from file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/room_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ext_include', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/room_list.tpl', 3, false),array('modifier', 't_escape', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/room_list.tpl', 23, false),)), $this); ?>
...
<tr>
<?php if ($this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['type'] == 1): ?>
<?php if ($this->_tpl_vars['hall_begin']): ?>
<td height=20 colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['hall_begin']); ?>
 align=center bgcolor=#000000>
</td>
<?php endif; ?>

<?php $_from = $this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['span_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item2']):
?>

<?php if ($this->_tpl_vars['item2']['span']): ?>
...
<td height=20 colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['day_time']-$this->_tpl_vars['hall_finish']); ?>
...
<?php $_from = $this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['loop_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item2']):
?>
<td colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['koma']); ?>
 bgcolor=#66CC00></td>
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['etc_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item2']):
?>
<td bgcolor=#FF6600></td>
<?php endforeach; endif; unset($_from); ?>
<?php if ($this->_tpl_vars['day_time'] - $this->_tpl_vars['hall_finish'] + 1): ?>
<td height=20 colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['day_time']-$this->_tpl_vars['hall_finish']+1); ?>
 align=center bgcolor=#000000></td>
<?php endif; ?>
<?php endif; ?>
...
<td colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['hall_begin']*$this->_tpl_vars['room_data'][$this->_tpl_vars['item']]['th_span']); ?>
 bgcolor=#000000></td>
...
<?php if ($this->_tpl_vars['min'] > $this->_tpl_vars['hall_begin'] && $this->_tpl_vars['min'] <= $this->_tpl_vars['hall_finish']): ?>
...
<td colspan=23-<?php echo smarty_modifier_t_escape($this->_tpl_vars['hall_finish']); ?>
 bgcolor=#000000></td>
