<?php /* Smarty version 2.6.18, created on 2010-08-30 17:12:54
         compiled from file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ext_include', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 2, false),array('modifier', 't_escape', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 31, false),array('modifier', 'nl2br', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 179, false),array('modifier', 't_url2cmd', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 179, false),array('modifier', 't_cmd', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 179, false),array('modifier', 't_decoration', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 179, false),array('modifier', 'default', 'file:/var/www/atoffice_torioki20100712/webapp/modules/admin/templates/reserve_revision.tpl', 634, false),)), $this); ?>
...
<td>
<?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['total_price']); ?>
円
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>合計請求金額</td>
<td>
<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['total_price']); ?>
円
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>利用開始日時</td>
<td>
<input tyep="text" name="begin_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['begin_datetime']); ?>
">
</td>
<td width=100 bgcolor=#DEDEDE>利用終了日時</td>
<td>
<input tyep="text" name="finish_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['finish_datetime']); ?>
">
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>仮予約日</td>
<td>
<input tyep="text" name="tmp_reserve_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['tmp_reserve_datetime']); ?>
">
</td>
<td width=100 bgcolor=#DEDEDE>予約承認日</td>
<td>
<input tyep="text" name="reserve_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['reserve_datetime']); ?>
">
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>仮予約フラグ</td>
<td>
<input type="radio" name="tmp_flag" value="1" <?php if ($this->_tpl_vars['reserve_data']['tmp_flag'] == 1): ?>checked<?php endif; ?>>仮予約
<input type="radio" name="tmp_flag" value="0" <?php if ($this->_tpl_vars['reserve_data']['tmp_flag'] == 0): ?>checked<?php endif; ?>>予約承認済み
</td>
<td width=100 bgcolor=#DEDEDE>キャンセルフラグ</td>
<td>
...
<td width=100 bgcolor=#DEDEDE>予約変更フラグ</td>
<td>
<input type="radio" name="change_flag" value="1" <?php if ($this->_tpl_vars['reserve_data']['change_flag'] > 0): ?>checked<?php endif; ?>>変更済み
<input type="radio" name="change_flag" value="0" <?php if ($this->_tpl_vars['reserve_data']['change_flag'] == 0): ?>checked<?php endif; ?>>未変更
</td>
<td width=100 bgcolor=#DEDEDE>利用予定人数</td>
<td>
<input tyep="text" name="people" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['people']); ?>
...
<td width=100 bgcolor=#DEDEDE>予約変更日</td>
<td>
<input tyep="text" name="change_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['change_datetime']); ?>
">
</td>
<td width=100 bgcolor=#DEDEDE>予約キャンセル日</td>
<td>
<input tyep="text" name="cancel_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['cancel_datetime']); ?>
">
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>入金期限日</td>
<td>
<input tyep="text" name="pay_limitdate" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['pay_limitdate']); ?>
">
</td>
<td width=100 bgcolor=#DEDEDE>最終入金日</td>
<td>
<input tyep="text" name="pay_checkdate" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['pay_checkdate']); ?>
">
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>入金済みフラグ</td>
<td>
<input type="radio" name="pay_flag" value="1" <?php if ($this->_tpl_vars['reserve_data']['pay_flag'] == 1): ?>checked<?php endif; ?>>入金済み
<input type="radio" name="pay_flag" value="0" <?php if ($this->_tpl_vars['reserve_data']['pay_flag'] == 0): ?>checked<?php endif; ?>>未入金 or 一部入金
</td>
<td width=100 bgcolor=#DEDEDE>入金済み金額</td>
<td>
<input tyep="text" name="pay_money" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['pay_money']); ?>
...
<td width=100 bgcolor=#DEDEDE>部屋利用料金</td>
<td>
<input tyep="text" name="room_price" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['room_price']); ?>
" style="text-align:right;padding-right:5px;">円
</td>
<td width=100 bgcolor=#DEDEDE>備品利用料金</td>
<td>
<input tyep="text" name="vessel_price" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['vessel_price']); ?>
" style="text-align:right;padding-right:5px;">円
</td>
</tr>
...
<td width=100 bgcolor=#DEDEDE>サービス利用料金</td>
<td>
<input tyep="text" name="service_price" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['service_price']); ?>
" style="text-align:right;padding-right:5px;">円
</td>
<td width=100 bgcolor=#DEDEDE>合計請求金額</td>
<td>
<input tyep="text" name="total_price" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['total_price']); ?>
" style="text-align:right;padding-right:5px;">円
</td>
</tr>
<tr>
...
<td width=100 bgcolor=#DEDEDE>領収書印刷日</td>
<td>
<input tyep="text" name="receipt_datetime" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['reserve_data']['receipt_datetime']); ?>
">
</td>
</tr>
<tr>
