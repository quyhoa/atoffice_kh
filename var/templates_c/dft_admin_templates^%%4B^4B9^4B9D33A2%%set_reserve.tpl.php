<?php /* Smarty version 2.6.18, created on 2017-03-14 05:05:25
         compiled from file:E:%5CA_project%5Catoffice_kh/webapp/modules/admin/templates/set_reserve.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ext_include', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/set_reserve.tpl', 2, false),array('modifier', 't_escape', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/set_reserve.tpl', 14, false),)), $this); ?>
...
";
    ...
    function setRoomID(room_id) 
    {
        ...
        document.forms["reserve"].elements["a"].value = "page_<?php echo smarty_modifier_t_escape($this->_tpl_vars['hash_tbl']->hash('set_reserve','page')); ?>
";
        return true;
    }
...
">
            <?php if ($this->_tpl_vars['old_member'] != ''): ?>
                <input type="hidden" name="old_member" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['old_member']); ?>
">
            <?php endif; ?>
            <?php if ($this->_tpl_vars['old_hall'] != ''): ?>
                <input type="hidden" name="old_hall" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['old_hall']); ?>
">
            <?php endif; ?>
...
">
                    ...
                    <tr>
                        <td>顧客ID番号</td>
                        <td colspan=2>
                            <input type="text" name="c_member_id" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['old_member']); ?>
"><br>
                            ※ 新規の場合は未入力
                        </td>
                    </tr>
...
?>
         ...
         <?php if ($this->_tpl_vars['value']['usedate'] == 1 && $this->_tpl_vars['v']['style'] && ! $this->_tpl_vars['v']['reserved'] && ! $this->_tpl_vars['v']['checked'] && ! $this->_tpl_vars['v']['stoped']): ?>
            bgcolor= #FFE7D6
            <?php elseif ($this->_tpl_vars['value']['usedate'] == 0 && ! $this->_tpl_vars['v']['reserved'] && ! $this->_tpl_vars['v']['checked'] && ! $this->_tpl_vars['v']['stoped']): ?>
            bgcolor= #FFE7D6
            <?php endif; ?> colspan=<?php echo smarty_modifier_t_escape($this->_tpl_vars['v']['cs']); ?>
...
'>
        ...
        <?php endforeach; endif; unset($_from); ?>
        <?php else: ?>        <?php $_from = $this->_tpl_vars['value']['komawari']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?>
...
'>
        ...
        <?php else: ?>            <input type="hidden" name="room_id" value="0">
...
コマ以上<?php endif; ?>
 ...
 style='border: 1px #000000 solid;text-align: center;' bgcolor=#FF6666><b>休室日</b></td>
        ...
        <?php else: ?>        <?php if ($this->_tpl_vars['value']['type'] == 2): ?>
         <?php $_from = $this->_tpl_vars['value']['opentime']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?>
        <td style='border: 1px #000000 solid;text-align: center;vertical-align:middle;'
