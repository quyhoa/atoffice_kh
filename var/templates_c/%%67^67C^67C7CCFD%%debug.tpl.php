<?php /* Smarty version 2.6.18, created on 2017-03-23 10:21:23
         compiled from D:%5CA_project%5Catoffice_kh/webapp/templates/debug.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_debug_info', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 3, false),array('function', 'cycle', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 119, false),array('modifier', 't_escape', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 99, false),array('modifier', 'escape', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 102, false),array('modifier', 'string_format', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 105, false),array('modifier', 'debug_print_var', 'D:\\A_project\\atoffice_kh/webapp/templates/debug.tpl', 121, false),)), $this); ?>
...
$this->_sections['templates']['loop'] = is_array($_loop=smarty_modifier_t_escape($this->_tpl_vars['_debug_tpls'])) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['indent']['loop'] = is_array($_loop=smarty_modifier_t_escape($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth'])) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?>
    <font color=<?php if (smarty_modifier_t_escape($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type']) == 'template'): ?>brown<?php elseif (smarty_modifier_t_escape($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type']) == 'insert'): ?>black<?php else: ?>green<?php endif; ?>>
        <?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['filename']))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</font>
...
$this->_sections['vars']['loop'] = is_array($_loop=smarty_modifier_t_escape($this->_tpl_vars['_debug_keys'])) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
">
            <th>{$<?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']]))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
}</th>
            <td><?php echo smarty_modifier_debug_print_var(smarty_modifier_t_escape($this->_tpl_vars['_debug_vals'][$this->_sections['vars']['index']])); ?>
</td></tr>
    <?php endfor; else: ?>
...
$this->_sections['config_vars']['loop'] = is_array($_loop=smarty_modifier_t_escape($this->_tpl_vars['_debug_config_keys'])) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
        <tr class="<?php echo smarty_function_cycle(array('values' => "odd,even"), $this);?>
">
            <th>{#<?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']]))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
#}</th>
            <td><?php echo smarty_modifier_debug_print_var(smarty_modifier_t_escape($this->_tpl_vars['_debug_config_vals'][$this->_sections['config_vars']['index']])); ?>
</td></tr>
    <?php endfor; else: ?>
...
<?php if (isset ( $this->_tpl_vars['_smarty_debug_output'] ) && smarty_modifier_t_escape($this->_tpl_vars['_smarty_debug_output']) == 'html'): ?>
    <?php echo smarty_modifier_t_escape($this->_tpl_vars['debug_output']); ?>
