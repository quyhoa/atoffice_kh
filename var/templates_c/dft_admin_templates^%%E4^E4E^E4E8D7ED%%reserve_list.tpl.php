<?php /* Smarty version 2.6.18, created on 2017-03-14 05:05:50
         compiled from file:E:%5CA_project%5Catoffice_kh/webapp/modules/admin/templates/reserve_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ext_include', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 2, false),array('modifier', 't_escape', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 24, false),array('modifier', 'nl2br', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 221, false),array('modifier', 't_url2cmd', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 221, false),array('modifier', 't_cmd', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 221, false),array('modifier', 't_decoration', 'file:E:\\A_project\\atoffice_kh/webapp/modules/admin/templates/reserve_list.tpl', 221, false),)), $this); ?>
<?php echo $this->_tpl_vars['inc_header']; ?>

<?php echo smarty_function_ext_include(array('file' => "inc_subnavi_adminSiteMember.tpl"), $this);?>

<?php $this->assign('page_name', "入金待ち予約一覧"); ?>
...
" />
<input type="hidden" name="a" value="page_<?php echo smarty_modifier_t_escape($this->_tpl_vars['hash_tbl']->hash('reserve_list','page')); ?>
" />
...
<?php if ($this->_tpl_vars['limit'] == 0): ?>checked<?php endif; ?>>すべて
<input type="radio" name="limit" value="1" 
<?php if ($this->_tpl_vars['limit'] == 1): ?>checked<?php endif; ?>>期限内
<input type="radio" name="limit" value="2" 
<?php if ($this->_tpl_vars['limit'] == 2): ?>checked<?php endif; ?>>期限切れ
</td>
</tr>
</table>
...
<?php else: ?>
	<a href="./?m=admin&a=page_reserve_list&hall_list=<?php echo smarty_modifier_t_escape($this->_tpl_vars['hall_id']); ?>
&u=<?php echo smarty_modifier_t_escape($this->_tpl_vars['c_member_id']); ?>
&limit=<?php echo smarty_modifier_t_escape($this->_tpl_vars['limit']); ?>
...
　□ <?php if ($this->_tpl_vars['item']['bill_id']): ?>(請求番号:<?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['bill_id']); ?>
	...
	<td <?php if ($this->_tpl_vars['item']['pay_limit'] <= 1 && $this->_tpl_vars['item']['pay_limit'] >= -4): ?>bgcolor=#FFFF99<?php elseif ($this->_tpl_vars['item']['pay_limit'] < -4): ?>bgcolor=#FF9999<?php endif; ?>><span style='margin:5px;'><?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['pay_limitdate']); ?>
　（残り<?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['pay_limit']); ?>
日）</span></td>	<td bgcolor=#FFD9DC width=100><span style='margin:5px;'>入金状態</span></td>
	<td><span style='margin:5px;'>
	<?php if ($this->_tpl_vars['item']['pay_money']): ?>
...
<br><?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['begin_datetime']); ?>
 ...
 人　/　
	...
	<?php else: ?>
		...
		<input type="hidden" name="m" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['module_name']); ?>
" />
		<input type="hidden" name="a" value="page_<?php echo smarty_modifier_t_escape($this->_tpl_vars['hash_tbl']->hash('payment','page')); ?>
" />
		<input type="hidden" name="reserve_id" value="<?php echo smarty_modifier_t_escape($this->_tpl_vars['item']['reserve_id']); ?>
">
		<input type="submit" value="入金処理">
		</form>
		</td>
		</tr>
		</table>
...
<?php endif; ?>
	...
	<tr>
	<td bgcolor=#FFD9DC width=100><span style='margin:5px;'>キャンセル料</span>
	</td>
	<td colspan=3>
...
" />
	...
	<td>
<center>
<?php if ($this->_tpl_vars['item']['complete_flag'] == 0): ?>
<center>
	<table><tr><td>
